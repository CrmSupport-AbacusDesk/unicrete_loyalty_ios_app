...
export class ContactPage {
  ...
  {
    console.log('map');
    let destination = 28.90903731508301 + ',' + 77.11608768061168;
   
    this.get_user_lang();    
    
    let label = encodeURI('A-214, 2nd Floor, Roman Court, Ansal Sushant City, Sector 61, Kundli, Delhi/NCRKundli - 131023, Haryana, India)');
