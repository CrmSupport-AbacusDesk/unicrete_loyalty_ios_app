...
export class OffersPage {
    ...
    getofferDetail(offer_id)
    {
        ...
        .subscribe((r)=>
        {
            ...
            var referral_per_amt = (( this.karigar_info.referal_point_balance * referral_per.one_time_percentage)/100);
           console.log( this.karigar_info.balance_point);
           
            this.balance_point=parseInt(this.karigar_info.balance_point) + (referral_per_amt);
            ...
            for (let i = 0; i < this.gift_list.length; i++) 
            {
                ...
                if(this.intVal(this.gift_list[i].coupon_points) <= this.intVal(this.balance_point)){
