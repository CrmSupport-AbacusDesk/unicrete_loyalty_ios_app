...
import {KarigarsDetailPage} from '../pages/karigars-detail/karigars-detail';
import {RemarkPage} from '../pages/remark/remark';
import { FileTransfer, FileUploadOptions, FileTransferObject } from '@ionic-native/file-transfer';
import { File } from '@ionic-native/file';
import { KarigarsPage } from '../pages/karigars/karigars';
import { KarigarGalleryPageModule } from '../pages/karigar-gallery/karigar-gallery.module';
import { KarigarGalleryPage } from '../pages/karigar-gallery/karigar-gallery';
...
import { KarigarsDetailPageModule } from '../pages/karigars-detail/karigars-detail.module';
